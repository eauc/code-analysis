...
(defn commit-words
  ...
  (->> commits
       ...
       (remove #(re-find #"(?i)^(|.|an|as|to|by|in|it|if|is|be|on|one|the|no|do|de|des|don|all|from|for|are|into|this|that|there|these|and|not|of|get|use|using|less|some|more|we|when|with|\d+)$" %))))
